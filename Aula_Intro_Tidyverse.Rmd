---
title: "Aprendendo ver os dados usando o Tidyverse"
...
Suponha que eu deseje **CRIAR** uma nova variavel, por exemplo, o PIB total dos paises. aqui devemos usar "=" 
...
Usando **group_by()** antes do **summarize()** transforma em grupos dentro de uma categoria.
...
Em um dos exemplos acima, nós encontramos a media da expectativa de 
vida e o total da populacao para o ano de 2007. Mas e se nao quisemos apenas Sumarizando pelo continente
...
observe que temos um problema no continente ASIA. Há dados missing NA. Agora que calculamos essas estatisticas para 2002, voce pode estar interessado em como elas mudaram para cada continente ao longo do tempo.  
```{r}
gapminder %>%
...
Resuma medianGdpPercap dentro de cada continente dentro cada ano: by_year_continent
...
Use o conjunto de dados by_year para criar um gráfico de linha mostrando a mudança em PIB médio per capita ao longo do tempo. Certifique-se de usar expand_limits (y = 0) para incluir 0 no eixo y.
...
Observe: x = continentes (categoria) e y = os valores de expectativa de vida

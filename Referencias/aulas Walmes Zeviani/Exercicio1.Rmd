---
title: "Exercícios Dplyr- adaptado das notas de aula do prof. Matheus Donato"
...
Você lembra qual função usamos para combinar as variaveis dentro de um mesmo banco de dados? Isso mesmo, `cbind()` e `rbind()`. Então por favor, junte as variaveis acima a partir de suas *colunas* atribuindo ao objeto "*notas*". Qual das duas funções você usará?

```{r}
# nome, escola, prof, genero, mat_nota, reading_nota
...
Nesse exercício nós normalmente apenas mostramos os resultados e não os salvamos, mas fique à vontade para salva-los se você quiser. Agora podemos ir para os exercícios. A maioria das sessões virão com um exemplo para você olhar e ter uma ideia do que pode ser feito e em cada sessão terão exercícios para o melhor entendimento de cada verbo.
